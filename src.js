<<<<<<< HEAD
const productos = [
					{id:1, nombre:"Cubo Rubik 2x2", precio:640, categoria:"2x2", stock:25, img:"./img/cubos/cubo2x2.jpg"},
					{id:2, nombre:"Cubo Rubik 3x3", precio:1240, categoria:"3x3", stock:51, img:"./img/cubos/cubo3x3.jpg"},
					{id:3, nombre:"Piramix 3x3", precio:640, categoria:"3x3", stock:11, img:"./img/cubos/piramix3x3.jpg"},
					{id:4, nombre:"Cubo Rubik 4x4", precio:1600, categoria:"4x4", stock:5, img:"./img/cubos/cubo4x4.jpg"},
					{id:5, nombre:"Cubo Mirror 3x3", precio:1000, categoria:"3x3", stock:15, img:"./img/cubos/cuboMirror3x3.jpg"},
					{id:6, nombre:"Llavero cubo 2x2", precio:1000, categoria:"2x2", stock:17, img:"./img/cubos/llavero2x2.jpg"},
					{id:7, nombre:"Llavero cubo 3x3", precio:1200, categoria:"3x3", stock:22, img:"./img/cubos/llavero3x3.jpg"}
					];
=======
/*const productos = [
...
<<<<<<< HEAD
function createCardCarrito (urlImg, precioProducto, cantidadProducto) {
=======
...
<<<<<<< HEAD
		createCardCarrito (producto.img, producto.precio,"1");
=======
...
for(let i=0;i<btnComprar.length;i++){
	...
	btnComprar[i].addEventListener("click", ()=>{
		...
		if(carrito.some((el)=>el.id===productos[i].id)){
			activarMensajeModal ("Este producto ya fue agregado al carrito","flex");
		}else{
			agregarAlCarrito (productos[i].id, productos[i].nombre, productos[i].precio, productos[i].img)
